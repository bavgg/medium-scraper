...
# Step 4: Function to get the number of claps from each component
...
# Step 5: Function to get the title from each component
...
# Step 6: Function to get the URL from each component
...
# Step 7: Initialize an Excel workbook
wb = Workbook()
ws = wb.active

# Step 8: Initialize a list for storing the JSON data
jason_list = []

# Step 9: Iterate over each component to extract the data
...
# Step 10: Write the data to a JSON file
